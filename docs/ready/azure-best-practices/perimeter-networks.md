...
description: Réseaux de périmètre
author: tracsman
ms.author: jonor
ms.date: 05/10/2019
ms.topic: guide
...
>
> - [Implémenter une zone DMZ entre Azure et votre centre de données local](/azure/architecture/reference-architectures/dmz/secure-vnet-hybrid)
> - [Implémenter une zone DMZ entre Azure et Internet](/azure/architecture/reference-architectures/dmz/secure-vnet-dmz)
...
[4]: ./images/network-hub-spoke-block-level-diagram.png "Diagramme de niveau bloc du hub-and-spoke"
...
[8]: ./images/network-vnet-peering-perimeter-neworks.png "Homologation de réseaux virtuels et réseaux de périmètre"
