---
title: 'Innovation Azure : Favoriser l’adoption'
description: Aidez les équipes de développeurs à créer des applications productives, à favoriser une collaboration mondiale sécurisée et à supprimer les obstacles à l’innovation dans Azure.
author: absheik
ms.author: absheik
ms.date: 10/17/2019
ms.topic: guide
...
# <a name="developer-productivity"></a>[Productivité des développeurs](#tab/DeveloperProductivity)
...
# <a name="innovate-collaboratively"></a>[Innover ensemble](#tab/Collaboration)
...
# <a name="liveops-innovation"></a>[Innovation LiveOps](#tab/LiveOps)
...
LiveOps permet aussi d’humaniser les données. Une approche LiveOps rend les données plus exploitables, de sorte que votre organisation peut prendre des mesures, en temps réel, ayant un impact sur vos applications, vos clients et votre entreprise. Il s’agit d’un processus axé sur l’expérimentation, qui met l’accent sur l’itération et l’évolution, ce qui entraîne des modifications cohérentes et fréquentes. LiveOps est une approche de la combinaison de DevOps avec votre CRM.
