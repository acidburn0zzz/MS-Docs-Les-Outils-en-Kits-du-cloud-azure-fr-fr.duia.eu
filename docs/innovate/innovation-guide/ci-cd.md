...
Les organisations reconnaissent que l’innovation est essentielle au succès des entreprises. Il n’est pas possible d’innover uniquement grâce à l’introduction de nouvelles technologies. Au lieu de cela, elle nécessite une attention profonde sur la prise en charge des personnes qui catalysent la modification et la création de la nouvelle valeur que les organisations cherchent. **Les développeurs** se trouvent au centre de la transformation numérique et leur permettre d’obtenir davantage d’informations nécessite une plus grande rapidité de développement. La mise en place de l’énergie créative des équipes de développeurs requiert une attention toute particulière pour qu’ils soient plus productifs, qu’ils favorisent une collaboration mondiale et sécurisée et qu’ils fassent tomber les barrières pour mettre à l’échelle l’innovation.
...
> - S’il y a une erreur que les organisations commettent en permanence, c’est d’essayer de créer de la valeur en considérant la technologie comme une solution.
> - Parfois, l’attitude dominante est « Il nous suffit d’utiliser plus de technologies pour améliorer les choses ». Toutefois, l’innovation est avant tout une histoire de personnes.
> - L’innovation est possible par la combinaison des personnes et de la technologie.

Les organisations qui innovent avec succès considèrent la vision, la stratégie, la culture, le potentiel unique et les fonctionnalités comme des éléments fondamentaux, avant de se tourner vers la technologie avec un objectif spécifique en tête. Chaque entreprise devient un éditeur de logiciels. L’embauche d’ingénieur logiciel se multiplie plus rapidement en dehors du secteur des technologies, selon les données LinkedIn.
...
**Accédez au [projet Azure DevOps](https://docs.microsoft.com/azure/devops-project).**
...
Le développement de logiciels est un travail d’équipe. La collaboration et le partage des connaissances au sein de l’équipe sont essentiels. Il est important de faire tomber les barrières entre développement et opérations. Il y a également une multitude de connaissances organisationnelles en dehors de l’équipe de produit principale qui peut être exploitée par le biais de plateformes telles que GitHub. GitHub, la plus grande communauté de développeurs, est au cœur de la communauté open source et restera une plateforme ouverte qui soutient tous les développeurs. La collaboration est au cœur de GitHub. Les développeurs ont effectué plus de 1 milliard de contributions au cours d’une année aux projets open source et aux référentiels privés hébergés sur GitHub. C’est là que les développeurs collaborent, stockent leur code source et gèrent l’intégration continue.

**Accéder à [Microsoft Teams](https://docs.microsoft.com/MicrosoftTeams)**

## <a name="open-source-innovation"></a>Innovation open source

Pour innover, de nombreux développeurs tirent parti du code open source. 80% à 90% du développement d’applications commence par du code open source. Tout ne tourne pas autour du code, mais également des communautés et des développeurs interconnectés dans le monde entier. Tirant parti d’un modèle de développement ouvert avec GitHub, les équipes innovent et collaborent, identifient les vulnérabilités de sécurité rapidement et découvrent les compétences des experts. Les équipes de développement d’entreprise peuvent intégrer des référentiels GitHub à Microsoft Teams et à Azure. Teams est la seule solution proposant chat écrit et audio et collaboration avec l’efficacité des workflows de processus métier, de réunions et d’applications Microsoft Office, le tout en une seule expérience utilisateur. C’est le hub du travail d’équipe et l’innovation.
...
## <a name="innovate-using-azure-devops"></a>Innover avec Azure DevOps
...
L’innovation pour les expériences client et les applications métier est primordiale pour tous les dirigeants. Que vous développiez des expériences web, mobiles, IoT ou de réalité mixte, l’innovation est essentielle au succès futur de votre organisation. Pour mettre à l’échelle l’innovation, les organisations doivent se concentrer sur l’empaquetage et l’expédition de leurs valeurs commerciales uniques sous forme de services composables, afin que les partenaires et les employés puissent participer facilement et efficacement à la génération de valeurs partagées. Azure propose une offre unique pour vous aider à initier et à mettre à l’échelle l’innovation au sein de votre organisation. Pour renforcer l’innovation, les développeurs professionnels actuels peuvent créer des applications et des blocs de construction qui permettent à d’autres experts de votre organisation de créer des applications sur une base fiable. Avec Azure; ils bénéficient d’une sécurité de bout en bout assurée par une équipe d’experts, et d’une conformité proactive à laquelle les entreprises, les gouvernements et les start-ups font confiance.

# <a name="liveops-innovationtabliveops"></a>[Innovation LiveOps](#tab/LiveOps)

## <a name="future-ready-liveops"></a>Prêt pour l’avenir : LiveOps

LiveOps est un processus de conception pour un engagement continu avec les clients qui se concentre sur le parcours du client de bout en bout. Il s’agit d’une approche de conception et axée sur la prestation de valeur à vos clients, mettant l’accent sur la satisfaction des clients et les résultats. LiveOps permet aussi d’humaniser les données. Une approche LiveOps rend les données plus exploitables, de sorte que votre organisation peut prendre des mesures, en temps réel, ayant un impact sur vos applications, vos clients et votre entreprise. Il s’agit d’un processus axé sur l’expérimentation, qui met l’accent sur l’itération et l’évolution, ce qui entraîne des modifications cohérentes et fréquentes. LiveOps est une approche de la combinaison de DevOps avec votre CRM. Les organisations novatrices adoptent une mentalité des opérations en temps réel (LiveOps).
