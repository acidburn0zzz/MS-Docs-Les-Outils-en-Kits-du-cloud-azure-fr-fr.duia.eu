...
Azure Boards et Azure Pipelines requièrent un portail distinct de GitHub et d’Azure. Bien démarrer avec [Azure DevOps Services](https://azure.microsoft.com/services/devops).
