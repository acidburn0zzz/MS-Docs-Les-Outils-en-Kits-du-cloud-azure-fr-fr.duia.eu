...
- Lors du déploiement de plusieurs instances d’environnements similaires, une fabrique d’environnement peut assurer la cohérence, améliorer la gouvernance et accélérer le déploiement. Le [parcours de gouvernance pour les grandes entreprises](../../govern/guides/complex/index.md) établit une approche qui crée une fabrique d’environnement qui évolue dans plusieurs régions.
