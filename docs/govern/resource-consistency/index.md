            ...
            <div class="cardPadding" >
                <div class="card" >
                    ...
                    <div class="cardText" style="padding-left:0px;">
                        <h3>Modèle de discipline Cohérence des ressources</h3>
                        <p class="x-hidden-focus">Télécharger le modèle pour documenter la discipline Cohérence des ressources.</p>
                    </div>
                </div>
            </div>
        </div>
