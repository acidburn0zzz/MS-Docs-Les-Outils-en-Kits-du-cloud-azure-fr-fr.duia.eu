...
![Vue d’ensemble du cycle de vie d’adoption du cloud](../_images/caf-overview.png)

Les sections suivantes reflètent le flux du cycle de vie d’adoption du cloud ci-dessus. Mais il est important de noter que l’adoption du cloud est un processus itératif (et non séquentiel), ce qui signifie que ces priorités concurrentes apparaissent (et parfois réapparaissent) à différents moments de votre parcours d’adoption du cloud.
...
L’adoption de principes agiles éprouvés faisant suite à des décisions techniques différées est l’approche à privilégier pour la plupart des instructions de ce framework. Cette approche suit un modèle cohérent : établir un état final général, passer rapidement à l’implémentation initiale, tester et valider des hypothèses, et enfin refactoriser tôt pour évaluer les hypothèses. Cet état d’esprit axé sur le développement maximise l’apprentissage et minimise les risques pour la valeur métier. Mais il nécessite un certain degré de tolérance envers l’ambiguïté.
...
## <a name="balance-during-strategy"></a>Équilibre pendant la stratégie
...
À l’instar des priorités de stratégie, il est nécessaire de trouver un équilibre durant la planification entre la profondeur de la planification initiale et les décisions techniques différées.
...
## <a name="balance-during-ready"></a>Équilibre pendant la préparation
